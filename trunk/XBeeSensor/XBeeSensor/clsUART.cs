        ...
        private void UART_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                //{
                    ...
                    if (read_count > 0 && readBuffer[intBufferIndex + read_count - 1] == 0)
                    {
                        intBufferIndex = 0;
                    ...
                    else
                    {
                        ...
                        //Thread.Sleep(1000); // pause to see if rest of command comes in
                    }
               // } while (UART.BytesToRead > 0);
                Debug.Assert(intBufferIndex < 20, "How do we get incomplete data?");
